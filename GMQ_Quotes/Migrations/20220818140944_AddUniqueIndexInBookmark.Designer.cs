...
namespace GMQ_Quotes.Migrations
{
    ...
    [Migration("20220818140944_AddUniqueIndexInBookmark")]
    partial class AddUniqueIndexInBookmark
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GMQ_Quotes.Data.Models.Bookmark", b =>
                {
                    b.HasOne("GMQ_Quotes.Data.Models.Quote", null)
                        .WithMany("Bookmarks")
                        .HasForeignKey("QuoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GMQ_Quotes.Data.Models.User", null)
                        .WithMany("Bookmarks")
